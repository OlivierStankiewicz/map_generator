...
from generation.tile_gen.terrain_gen.terrain_sprite_mappings.sprite_type_water import water_sprite_mappings

class WaterSpriteHandler(SpriteHandler):
    def __init__(self):
        self.conflict_neighbor_strings = {"NNN\nNNN\nNNA", "NNN\nNNN\nANN", "NNA\nNNN\nNNN", "ANN\nNNN\nNNN"}
        self.conflict_sprite_mappings = [
            ("NNN\nNNN\nNNA", TerrainSpriteType.SAND_INNER_CORNER, False, False),
            ("NNN\nNNN\nANN", TerrainSpriteType.SAND_INNER_CORNER, True, False),
