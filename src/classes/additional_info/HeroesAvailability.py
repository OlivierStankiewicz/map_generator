class HeroesAvailability:
    def __init__(self):
        ...
        self.gelare= True
        self.grindan= True
        self.sir_mullich= True
        self.adrienne= False
        self.catherine= False
        self.dracon= False
        self.gelu= False
        self.kilgor= False
        self.haart_lich= False
        self.mutare= False
        self.roland= False
        self.mutare_drake= False
        self.boragus= False
        self.xeron= False
        self.padding_156= False
        self.padding_157= False
        self.padding_158= False
        self.padding_159= False
